...
use rcryptfs::core::{FileSystemSession, FileType, FsDirEntry, FsTime, OpenFileTable, VirtualPath};
use rustyline::error::ReadlineError;

use crate::platform;

// Runs the interactive CLI shell with in-memory history for this session.
pub fn run_cli_shell<C: OpenFileTable>(handler: &FileSystemSession<C>) -> Result<()> {
